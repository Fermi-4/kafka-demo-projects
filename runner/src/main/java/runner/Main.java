...
public class Main {
	 ...
	 * KafkaRunnerImpl(Serde<K> _keySerde, Serde<T> _valueSerde, String _bootstrapServers, String _topic, long _requestTimeout,
			long _sampleTimeout)
	 */
	static KafkaRunner<String> runner = new KafkaRunnerImpl<String, String>(Serdes.String().deserializer(), Serdes.String().deserializer(), "localhost:9092", "test-topic-multipart", 5000, 5000);
